...
class FinancialProfile(BaseModel):
    ...
    mutual_funds: List[dict] = Field(default_factory=list, description='[{"fund_name","current_value_inr","isin"}]')
    stocks: List[dict] = Field(default_factory=list, description='[{"stock_name","current_value_inr","isin"}]')
